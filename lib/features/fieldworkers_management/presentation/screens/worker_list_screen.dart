  ...
  Navigator.push(
    ...
    MaterialPageRoute(
      builder: (_) => ChangeNotifierProvider(
        create: (_) {
          final vm = WorkerTaskViewModel();
          vm.loadTasksForWorker(worker.id);
          return vm;
        },
        child: WorkerTaskHistoryScreen(worker: worker),
      ),
    ),
  );
  break;
...
case 'evaluaciones':
  Navigator.push(
    ...
    MaterialPageRoute(
      builder: (_) => ChangeNotifierProvider(
        create: (_) => WorkerViewModel(),
        child: WorkerEvaluationScreen(worker: worker),
      ),
    ),
  );
  break;
